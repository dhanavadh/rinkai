...
<div class="hidden md:flex flex-col w-full">
  <div
    class="flex items-center justify-between max-w-7xl mx-auto py-4 px-6 gap-8 w-full"
  >
  ...
  <div
    class="flex items-center justify-between max-w-7xl mx-auto py-4 px-6 gap-8 w-full font-medium"
  >
